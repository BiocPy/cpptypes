...
directly_usable = set(
    ["int", "char", "float", "double", "long", "short", "size_t", "ssize_t", "bool"]
)
...
if lib is None:
    raise ImportError("failed to find the """
            + dll_prefix
            + """.* module")
        ...
        for k in all_function_names:
            ...
            if restype.base_type == "void" and restype.pointer_level == 0:
                ...
                try:
                    ...
                    raise ValueError(
                        "failed to convert return value for function '" + k + "'"
                    ) from exc
                handle.write(
            ...
            try:
                ...
                raise ValueError(
                    "failed to convert arguments for function '" + k + "'"
                ) from exc
